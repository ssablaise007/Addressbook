...
public class UC3_EditList{
	public static void main(String args[]) {
		Scanner scan = new Scanner(System.in);
		UC3_EditList addressObject = new UC3_EditList();
		String choice = "y";
		while(true) {
			...
			switch(switchChoice) {
				...
				case 2:
					...
					addressObject.insertContact(nameToEdit);
	...
	private void insertContact(String nameToEdit) {
	...
	private void insertContact(contactDetail contact) {
